...
public class RawInboundDataMessage : IInboundDataMessage
{
    ...
    {
        return $"RawInboundDataMessage {MessageId} ({RawMessageData.Length}B) Data:{RawMessageDataClearText}";
    }
    ...
    {
        return $"RawInboundDataMessage {MessageId} ({RawMessageData.Length}B)";
    }
}
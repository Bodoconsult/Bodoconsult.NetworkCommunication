...
/// <summary>
/// Basic implementation of <see cref="IOutboundBusinessTransactionDataMessage"/> for BTCP protocol request
/// </summary>
public class BtcpRequestOutboundDataMessage : IOutboundBusinessTransactionDataMessage
{
    ...
    public BtcpRequestOutboundDataMessage(int businessTransactionId, Guid businessTransactionUid)
    {
    ...
    {
        return $"BtcpOutboundDataMessage ID {MessageId} BT {BusinessTransactionId} / {BusinessTransactionUid}: {RawMessageDataClearText}";
    }
    ...
    {
        return $"BtcpOutboundDataMessage ID {MessageId} BT {BusinessTransactionId} / {BusinessTransactionUid}";
    }
}
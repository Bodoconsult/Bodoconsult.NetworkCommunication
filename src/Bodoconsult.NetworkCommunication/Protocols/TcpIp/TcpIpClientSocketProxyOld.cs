...
///// </summary>
//public class TcpIpClientSocketProxyOld : BaseTcpIpSocketProxy
//{
...
//    public TcpIpClientSocketProxyOld(IAppLoggerProxy logger) : base(logger)
//    { }
...
//            Logger.LogInformation($"{LoggerId}TcpClientSocket: received {result} bytes");
//            return result;
//        }
//        catch (SocketException socketException)
//        {
//            if (socketException.ErrorCode != 10054)
//            {
//                var s = $"{LoggerId}{socketException}";
//                Logger.LogError(s);
//            }

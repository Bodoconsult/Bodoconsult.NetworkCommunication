...
//        }
//        return !Socket.Connected ? await Task.FromResult(0) : await Socket.ReceiveAsync(buffer, SocketFlags.None, CancellationTokenSource.Token);
//    }

//    ///// <summary>
//    ///// Receive data from the socketa
//    ///// </summary>
//    ///// <param name="buffer">Byte array to store the received byte data in</param>

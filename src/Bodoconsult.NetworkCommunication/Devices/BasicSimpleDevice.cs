...
/// </summary>
public class BasicSimpleDevice : BaseSimpleDevice
{
    /// <summary>
    /// Default ctor
    /// </summary>
    ...
    public BasicSimpleDevice(IDataMessagingConfig dataMessagingConfig, ICentralClientNotificationManager clientNotificationManager) : 

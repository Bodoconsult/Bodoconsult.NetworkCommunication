...
/// <summary>
/// Factory to create a client instance of <see cref="AsyncUdpSocketProxy"/>
/// </summary>
public class ClientAsyncUdpSocketProxyFactory : ISocketProxyFactory
{
    /// <summary>
    ...
    {
        return new AsyncUdpSocketProxy(false);
    }
}
...
/// <summary>
/// Order builder to create a BTCP order ONLY waiting for an answer
/// </summary>
public class OnlyAnswerBtcpOrderBuilder : BaseOrderBuilder
{
    ...
    /// Default ctor
    /// </summary>
    public OnlyAnswerBtcpOrderBuilder() : base(typeof(BtcpParameterSet), BuiltinOrders.OnlyAnswerBtcpOrder)
    { }
    ...
    public override void ConfigureOrder(IOrder order, IOrderConfiguration config)
    {
        ...
        var requestAnswer = CreateRequestAnswer(requestAnswerStep, "ReceivedMessage", BtcpOrderBuilder.CheckReceivedMessageDelegate, oc.HandleRequestAnswerOnSuccessDelegate);

...
/// </summary>
public class OnlyAnswerEdcpClientOrderBuilder : BaseOrderBuilder
{
    ...
    /// Default ctor
    /// </summary>
    public OnlyAnswerEdcpClientOrderBuilder() : base(typeof(EdcpParameterSet), BuiltinOrders.OnlyAnswerEdcpClientOrder)
    { }
    ...
    public override void ConfigureOrder(IOrder order, IOrderConfiguration config)
    {
        ...
        var requestAnswer = CreateRequestAnswer(requestAnswerStep, "ReceivedMessage", EdcpClientOrderBuilder.CheckReceivedMessageDelegate, oc.HandleRequestAnswerOnSuccessDelegate);

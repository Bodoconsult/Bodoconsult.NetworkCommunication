...
/// <summary>
/// Order builder to create a TNCP order ONLY waiting for an answer
/// </summary>
public class OnlyAnswerTncpOrderBuilder : BaseOrderBuilder
{
    ...
    /// Default ctor
    /// </summary>
    public OnlyAnswerTncpOrderBuilder() : base(typeof(TncpParameterSet), BuiltinOrders.OnlyAnswerTncpOrder)
    { }
    ...
    public override void ConfigureOrder(IOrder order, IOrderConfiguration config)
    {
        ...
        CreateRequestAnswer(requestAnswerStep, "ReceivedMessage", TncpOrderBuilder.CheckReceivedMessageDelegate, oc.HandleRequestAnswerOnSuccessDelegate);

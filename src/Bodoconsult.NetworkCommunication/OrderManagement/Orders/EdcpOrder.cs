...
/// </summary>
public class EdcpOrder : BaseOrder
{
    /// <summary>
    /// Default ctor
    /// </summary>
    ...
    public EdcpOrder(IParameterSet parameterSet, IAppDateService dateTimeService, IAppBenchProxy benchLogger) : base(
        parameterSet, dateTimeService, benchLogger)
    {
        TraceCodeSuccess = TraceCodes.IdsMsgEdcpOrderOk;
        TraceCodeError = TraceCodes.IdsMsgEdcpOrderFails;

        TraceMessage = "EDCP outbound order";
    }
}
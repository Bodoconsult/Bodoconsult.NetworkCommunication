...
/// </summary>
public class TncpOrder : BaseOrder
{
    /// <summary>
    /// Default ctor
    /// </summary>
    ...
    public TncpOrder(IParameterSet parameterSet, IAppDateService dateTimeService, IAppBenchProxy benchLogger) : base(parameterSet, dateTimeService, benchLogger)
    {
        TraceCodeSuccess = TraceCodes.IdsMsgTncpOrderOk;
        TraceCodeError = TraceCodes.IdsMsgTncpOrderFails;

        TraceMessage = "TNBC outbound order";
    }
}
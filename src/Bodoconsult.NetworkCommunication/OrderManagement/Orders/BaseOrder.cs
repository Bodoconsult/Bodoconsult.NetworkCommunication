...
public abstract class BaseOrder : IOrder
{
    ...
    /// </summary>
    public int TraceCodeSuccess { get; protected set; }

    /// <summary>
    /// Trace code to log on error
    /// </summary>
    public int TraceCodeError { get; protected set; }
    ...
    public virtual void CreateTraceEntry(IOrderExecutionResultState lastStepExecutionResult, in int communicationAdapterError)
    {
        ...
        TraceEntry.TraceDate = _dateTimeService.Now;
        //TraceEntry.Uid = GetFormattedUser();
        TraceEntry.TraceDate = DateTime.Now;
    }

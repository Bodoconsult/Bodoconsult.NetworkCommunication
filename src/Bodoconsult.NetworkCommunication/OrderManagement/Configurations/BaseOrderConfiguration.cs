...
///// <summary>
///// BTCP order configuration
///// </summary>
//public class BtcpOrderConfiguration : BaseOrderConfiguration
//{
//    /// <summary>
//    /// Default ctor
//    /// </summary>
...
//    /// <param name="orderTypeName">Name of the order type</param>
//    /// <param name="orderBuilder">Order builder instance to use for order creation</param>
//    public BtcpOrderConfiguration(string configurationName, string orderTypeName, IOrderBuilder orderBuilder) : base(configurationName, orderTypeName, orderBuilder)
//    { }
...
//    /// <summary>
//    /// ID of the requested business transaction
//    /// </summary>

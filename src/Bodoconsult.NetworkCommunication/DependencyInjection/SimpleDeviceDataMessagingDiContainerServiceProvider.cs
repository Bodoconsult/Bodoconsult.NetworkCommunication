...
/// <summary>
/// Provider adding default services for data messaging without order management and state management
/// </summary>
public class SimpleDeviceDataMessagingDiContainerServiceProvider : IDiContainerServiceProvider
{
    /// <summary>

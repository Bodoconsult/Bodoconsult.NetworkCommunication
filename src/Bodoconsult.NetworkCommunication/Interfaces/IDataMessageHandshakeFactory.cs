...
public interface IDataMessageHandshakeFactory
{
    ...
    IOutboundHandShakeDataMessage GetAckResponse(IInboundDataMessage message);
    ...
    IOutboundHandShakeDataMessage GetNakResponse(IInboundDataMessage message);
    ...
    IOutboundHandShakeDataMessage GetCanResponse(IInboundDataMessage message);
}
...
/// <summary>
/// Interface for device request specifications waiting for no handshake and no answer(s)
/// </summary>
public interface INoHandshakeNoAnswerDeviceRequestSpec : IRequestSpec
{
    /// <summary>

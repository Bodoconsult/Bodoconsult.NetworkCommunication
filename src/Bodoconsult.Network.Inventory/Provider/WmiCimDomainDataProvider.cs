...
/// </summary>
public class WmiCimDomainDataProvider : WmiCimBaseProvider, IWmiDomainDataProvider
{

    /// <summary>
    /// default ctor
    /// </summary>
    public WmiCimDomainDataProvider()
    {
    ...
    public void GetUsers(XmlNode node, string groupName)
    {
        ...
        try
        {
            ...
            var results = WmiCimHelper.ExecuteQuery(CimSession, wmiPath, wql.QueryString);
            ...
            {
                var path = new ManagementPath(o.CimInstanceProperties["PartComponent"].ToString());

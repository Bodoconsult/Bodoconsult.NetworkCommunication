						...
						ip_start_callback, ip_complete_callback, finish_callback)
{
						...
						ip_start_callback, ip_complete_callback, finish_callback)
  {
	...
	["logicaldrive", "Logical drives", "Win32_LogicalDisk", "Logical drives", "Logical drives", this._collectLogicalDrivesInfo],
  ...
  this._collectDiskDrivesInfo = function(Obj, xmlDoc, root)
  {
    ...
    this._collectLogicalDrivesInfo = function(Obj, xmlDoc, root)
  {
    this._xmlCreateChildTextNode(xmlDoc, root, "Name", Obj.Name);
    this._xmlCreateChildTextNodeWithAttribute(xmlDoc, root, "Size", Obj.Size, "name", "Size, bytes");
    this._xmlCreateChildTextNode(xmlDoc, root, "FreeSpace", Obj.FreeSpace, "name", "Size, bytes");
	this._xmlCreateChildTextNode(xmlDoc, root, "DriveType", Obj.DriveType);
	this._xmlCreateChildTextNode(xmlDoc, root, "FileSystem", Obj.FileSystem);
  }
  ...
  */
  ...
  this._collectOsInfo = function(Obj, xmlDoc, root)
  {
    ...
    this._xmlCreateChildTextNode(xmlDoc, root, "Manufacturer", Obj.Manufacturer);
	this._xmlCreateChildTextNodeWithAttribute(xmlDoc, root, "InstallDate", Obj.InstallDate, "name", "Install date");
	this._xmlCreateChildTextNodeWithAttribute(xmlDoc, root, "ThermalState", Obj.ThermalState, "name", "ThermalState");

...
namespace Bodoconsult.Snmp.mib.RFC1157
{
  ...
  {
    public syntax()
      : base((YyParser) new yysyntax(), (Lexer) new tokens())
    {
    }

    public syntax(YyParser syms)
      : base(syms, (Lexer) new tokens())
    {
    }

    public syntax(YyParser syms, ErrorHandler erh)
      : base(syms, (Lexer) new tokens(erh))
    {
    }
  }
}

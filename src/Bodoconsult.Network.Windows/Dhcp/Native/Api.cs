...
internal static class Api
{
    ...
    /// <param name="preferredMaximum">Specifies the preferred maximum number of bytes of options to return. If the number of remaining unenumerated options (inB) is less than this value, then that amount will be returned.
    ...
    /// <param name="preferredMaximum">Specifies the preferred maximum number of bytes of options to return. If the number of remaining unenumerated option definitions (inB) is less than this value, all option definitions are returned.</param>
    ...
    /// The presence of additional enumerable data is indicated when this function returns ERROR_MORE_DATA. If no additional enumerable data is available on the DHCPv4 server, ERROR_NO_MORE_ITEMS is returned.</param>
    /// <param name="preferredMaximum">Specifies the preferred maximum number of bytes of option values to return. If the number of remaining unenumerated options (inB) is less than this value, then that amount will be returned.
    ...
    /// <param name="resumeHandle">Pointer to a DHCP_RESUME_HANDLE value that identifies the enumeration operation. Initially, this value should be zero, with a successful call returning the handle value used for subsequent enumeration requests. For example, if PreferredMaximum is set to 1000 bytes, and 2000 bytes' worth of option values are stored on the server, the resume handle can be used after the first 1000 bytes are retrieved to obtain the next 1000 on a subsequent call, and so forth.</param>
    /// <param name="preferredMaximum">Specifies the preferred maximum number of bytes of option values to return. If the number of remaining unenumerated options (inB) is less than this value, all option values are returned.</param>
    ...
    /// <param name="preferredMaximum">The preferred maximum number of bytes of subnet client information structures to return. If the number of remaining unenumerated options (inB) is less than this value, then that amount will be returned.</param>
    ...
    /// The presence of additional enumerable data is indicated when this function returns ERROR_MORE_DATA. If no additional enumerable data is available on the DHCPv4 server, ERROR_NO_MORE_ITEMS is returned.</param>
    /// <param name="preferredMaximum">Specifies the preferred maximum number of bytes of subnet elements to return. If the number of remaining unenumerated options (inB) is less than this value, then that amount will be returned.

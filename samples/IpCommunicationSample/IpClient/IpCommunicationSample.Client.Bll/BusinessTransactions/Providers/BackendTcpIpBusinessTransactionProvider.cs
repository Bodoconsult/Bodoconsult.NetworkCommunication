...
namespace IpCommunicationSample.Client.Bll.BusinessTransactions.Providers
{
    ...
    {
        public readonly BtcpBackendTcpIpBusinessLogicAdapter BusinessLogicAdapter;

        /// <summary>
        /// Default ctor
        /// </summary>
        public BackendTcpIpBusinessTransactionProvider(BtcpBackendTcpIpBusinessLogicAdapter businessLogicAdapter)
        {

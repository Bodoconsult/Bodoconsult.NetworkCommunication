...
namespace IpCommunicationSample.Backend.Bll.Communication.ClientTcpIp;

public class ClientTcpIpConfigurator: BaseIpDeviceConfigurator
{
    ...
    public ClientTcpIpConfigurator(IDuplexIoFactory duplexIoFactory,

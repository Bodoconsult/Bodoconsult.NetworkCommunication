...
internal class BtcpDataMessageSplitterTests
{
    ...
    public void TryReadCommand_2ValidCommands_ReturnsCommand()
    {
        ...
        var expectedResult = new ReadOnlySequence<byte>([0x2, 0x31, 0x4, 0x6c, 0x75, 0x62, 0x62, 0x3]);
    ...
    public void TryReadCommand_1validCommand_ReturnsCommand()
    {
        // Arrange 
        var splitter = new BtcpDataMessageSplitter();
        var msg = new byte[] { 0x2, 0x31, 0x4, 0x6c, 0x75, 0x62, 0x62, 0x2, 0x42, 0x6b, 0x75, 0x62, 0x62, 0x3 };

        var expectedResult = new ReadOnlySequence<byte>([ 0x2, 0x31, 0x4, 0x6c, 0x75, 0x62, 0x62, 0x2, 0x42, 0x6b, 0x75, 0x62, 0x62, 0x3 ]);

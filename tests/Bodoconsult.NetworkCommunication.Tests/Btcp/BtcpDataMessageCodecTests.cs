...
internal class BtcpDataMessageCodecTests
{
    ...
    {
        // Arrange 
        var msg = new byte[] { 0x2, 0x0, 0x32, 0x30, 0x31, 0x4, 0x35, 0x65, 0x31, 0x37, 0x34, 0x65, 0x62, 0x65, 0x2d, 0x30, 0x63, 0x64, 0x30, 0x2d, 0x34, 0x36, 0x33, 0x65, 0x2d, 0x61, 0x32, 0x64, 0x31, 0x2d, 0x39, 0x34, 0x31, 0x66, 0x66, 0x39, 0x34, 0x65, 0x65, 0x66, 0x61, 0x65, 0x4, 0x30, 0x7c, 0x7c, 0x7c, 0x78, 0x30, 0x7c, 0x7c, 0x4, 0x3 };
    ...
    [Test]
    public void DecodeDataMessage_ValidInputRealWorld3_MessageDecoded()
    {
        // Arrange 
        var msg = new byte[]
            { 0x2, 0x1, 0x32, 0x30, 0x31, 0x4, 0x66, 0x39, 0x30, 0x38, 0x31, 0x37, 0x66, 0x65, 0x2d, 0x30, 0x37, 0x34, 0x36, 0x2d, 0x34, 0x35, 0x36, 0x32, 0x2d, 0x38, 
                0x37, 0x65, 0x63, 0x2d, 0x62, 0x38, 0x37, 0x35, 0x63, 0x38, 0x34, 0x62, 0x33, 0x30, 0x63, 0x39, 0x4, 0x78, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x88, 
                0x13, 0x0, 0x0, 0xe8, 0x4, 0x3 };
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(btcp.DataBlock.Data.Length, Is.EqualTo(13));
        }
    }

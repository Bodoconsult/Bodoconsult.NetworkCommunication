...
internal class TncpDataMessageSplitterTests
{
    ...
    [Test]
    public void TryReadCommand_ValidDataReplyMessage4_CommandReturned()
    {
        // Arrange 
        const string reply = "<BEGIN>set,stream,order,1,2,3,4\n";
        ...
        var data = new byte[]
        {
            0x3c, 0x42, 0x45, 0x47, 0x49, 0x4e, 0x3e, 0x73, 0x65, 0x74, 0x2c, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2c, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2c, 0x31, 0x2c, 0x32, 0x2c, 0x33, 0x2c, 0x34, 0xa,
            0x3c, 0x42, 0x45, 0x47, 0x49, 0x4e, 0x3e, 0x73, 0x65, 0x74, 0x2c, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2c, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2c, 0x31, 0x2c, 0x32, 0x2c, 0x33, 0x2c, 0x34, 0xa
        };
        var ros = new ReadOnlySequence<byte>(data);
    ...
    [Test]
    public void TryReadCommand_ValidDataReplyMessage5_CommandReturned()
    {
        // Arrange 
        const string reply = "<BEGIN>set,stream,order,1,4\n";

        var data = new byte[]
        {
            0x3c, 0x42, 0x45, 0x47, 0x49, 0x4e, 0x3e, 0x73, 0x65, 0x74, 0x2c, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2c, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2c, 0x31, 0x2c, 0x34, 0xa, 0xa
        };
        var ros = new ReadOnlySequence<byte>(data);
    ...
    [Test]
    public void TryReadCommand_ValidDataReplyMessage6_CommandReturned()
    {
        // Arrange 
        const string reply = "<BEGIN>set,stream,order,1,4\n";
        ...
        var data = new byte[]
        {
            0x3c, 0x42, 0x45, 0x47, 0x49, 0x4e, 0x3e, 0x73, 0x65, 0x74, 0x2c, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2c, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2c, 0x31, 0x2c, 0x34, 0xa
        };
        var ros = new ReadOnlySequence<byte>(data);

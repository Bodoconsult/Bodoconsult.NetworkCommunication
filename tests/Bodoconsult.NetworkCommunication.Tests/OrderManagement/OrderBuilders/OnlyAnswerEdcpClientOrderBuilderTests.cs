...
[TestFixture]
internal class OnlyAnswerEdcpClientOrderBuilderTests : OrderBuilderTestsBase
{
    [Test]
    public void Ctor_ValidSetup_PropsSetCorrectly()
    {
        ...
        // Act  
        var builder = new OnlyAnswerEdcpClientOrderBuilder();

        // Assert
        using (Assert.EnterMultipleScope())
        {
            Assert.That(builder.OrderTypeName, Is.EqualTo(BuiltinOrders.OnlyAnswerEdcpClientOrder));
    ...
    public void CreateOrder_ValidSetup_OrderCreated()
    {
        ...
        var config = new OneRequestSpecNoOrOneStepOneAnswerConfiguration("TestConfig", BuiltinOrders.OnlyAnswerEdcpClientOrder, builder)
        {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            var rs = (IOnlyAnswerDeviceRequestSpec?)order.RequestSpecs.FirstOrDefault();
    ...
    [Test]
    public void CreateOnlyAnswerDeviceRequestSpec_ValidSetup_RequestSpecCreated()
    {
        // Arrange 
        var ps = new EdcpParameterSet();
        var builder = new OnlyAnswerEdcpClientOrderBuilder();
        ...
        {
            const string name = "RequestSpec";
            var requestSpec = builder.CreateOnlyAnswerDeviceRequestSpec(order, name, HandleRequestAnswerOnSuccessDelegate);
    ...
    [Test]
    public void CreateNoHandshakeOnlyAnswerDeviceRequestSpec_ValidSetup_RequestSpecCreated()
    {
        // Arrange 
        var ps = new EdcpParameterSet();
        var builder = new OnlyAnswerEdcpClientOrderBuilder();

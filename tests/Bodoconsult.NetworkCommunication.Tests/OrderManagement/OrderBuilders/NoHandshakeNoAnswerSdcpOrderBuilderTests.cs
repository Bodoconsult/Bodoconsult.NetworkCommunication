...
[TestFixture]
internal class NoHandshakeNoAnswerSdcpOrderBuilderTests : OrderBuilderTestsBase
{
	[Test]
	public void Ctor_ValidSetup_PropsSetCorrectly()
	{
		...
		{
			Assert.That(builder.OrderTypeName, Is.EqualTo(BuiltinOrders.NoHandshakeNoAnswerSdcpOrder));
	...
	public void CreateOrder_ValidSetup_OrderCreated()
	{
		...
		var config = new OneRequestSpecNoOrOneStepOneAnswerConfiguration("TestConfig", BuiltinOrders.NoHandshakeNoAnswerSdcpOrder, builder)
		{
			OrderId = 1,

...
[TestFixture]
internal class NoAnswerSdcpOrderBuilderTests : OrderBuilderTestsBase
{
    [Test]
    public void Ctor_ValidSetup_PropsSetCorrectly()
    {
        ...
        {
            Assert.That(builder.OrderTypeName, Is.EqualTo(BuiltinOrders.NoAnswerSdcpOrder));
    ...
    public void CreateOrder_ValidSetup_OrderCreated()
    {
        ...
        var config = new OneRequestSpecNoOrOneStepOneAnswerConfiguration("TestConfig", BuiltinOrders.NoAnswerSdcpOrder, builder)
        {

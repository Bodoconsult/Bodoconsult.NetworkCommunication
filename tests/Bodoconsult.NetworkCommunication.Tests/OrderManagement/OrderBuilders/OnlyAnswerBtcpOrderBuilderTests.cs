...
[TestFixture]
internal class OnlyAnswerBtcpOrderBuilderTests : OrderBuilderTestsBase
{
    [Test]
    public void Ctor_ValidSetup_PropsSetCorrectly()
    {
        ...
        // Act  
        var builder = new OnlyAnswerBtcpOrderBuilder();

        // Assert
        using (Assert.EnterMultipleScope())
        {
            Assert.That(builder.OrderTypeName, Is.EqualTo(BuiltinOrders.OnlyAnswerBtcpOrder));
    ...
    public void CreateOrder_ValidSetup_OrderCreated()
    {
        ...
        var config = new OneRequestSpecNoOrOneStepOneAnswerConfiguration("TestConfig", BuiltinOrders.OnlyAnswerBtcpOrder, builder)
        {

...
[TestFixture]
internal class OnlyAnswerSdcpOrderBuilderTests : OrderBuilderTestsBase
{
    [Test]
    public void Ctor_ValidSetup_PropsSetCorrectly()
    {
        ...
        // Act  
        var builder = new OnlyAnswerSdcpOrderBuilder();

        // Assert
        using (Assert.EnterMultipleScope())
        {
            Assert.That(builder.OrderTypeName, Is.EqualTo(BuiltinOrders.OnlyAnswerSdcpOrder));
    ...
    public void CreateOrder_ValidSetup_OrderCreated()
    {
        ...
        var config = new OneRequestSpecNoOrOneStepOneAnswerConfiguration("TestConfig", BuiltinOrders.OnlyAnswerSdcpOrder, builder)
        {

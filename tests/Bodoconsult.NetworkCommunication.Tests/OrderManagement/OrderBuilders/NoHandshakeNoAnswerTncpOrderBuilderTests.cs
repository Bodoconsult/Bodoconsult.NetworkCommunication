...
[TestFixture]
internal class NoHandshakeNoAnswerTncpOrderBuilderTests : OrderBuilderTestsBase
{
    [Test]
    public void Ctor_ValidSetup_PropsSetCorrectly()
    {
        ...
        // Act  
        var builder = new NoHandshakeNoAnswerTncpOrderBuilder();

        // Assert
        using (Assert.EnterMultipleScope())
        {
            Assert.That(builder.OrderTypeName, Is.EqualTo(BuiltinOrders.NoHandshakeNoAnswerTncpOrder));
    ...
    public void CreateOrder_ValidSetup_OrderCreated()
    {
        ...
        var config = new OneRequestSpecNoOrOneStepOneAnswerConfiguration("TestConfig", BuiltinOrders.NoAnswerTncpOrder, builder)
        {

...
//{
//    private readonly ITowerServer _towerServer = TestDataHelper.GetTowerServer();
//    private readonly IDateTimeService _dateTimeService = new FakeDateTimeService();
...
//    private readonly FakeTowerRequestAnswerDelegate _towerRequestAnswerDelegate = new();
...
//        _requestProcessorFactory = new RequestProcessorFactory(requestStepProcessorFactory, _towerServer);

//        _towerRequestAnswerDelegate.TowerServer = _towerServer;
//        _towerRequestAnswerDelegate.SmdTower = _towerServer.SmdTower;
//    }
...
//        var factory = new MaterialUnloadOrderFactory(_towerRequestAnswerDelegate, _dateTimeService, _benchLogger);

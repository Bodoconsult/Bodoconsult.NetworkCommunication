...
internal class ClientSocketProxyFactoryTests
{
    ...
    public void CreateInstance_Client_Tcp_InstanceCreated()
    {
        ...
        // Act  
        var result = factory.CreateInstance(false,protocol, _ipAddress, _port, TestDataHelper.Logger, 512);
    ...
    public void CreateInstance_Server_Tcp_InstanceCreated()
    {
        ...
        // Act  
        var result = factory.CreateInstance(true, protocol, _ipAddress, _port, TestDataHelper.Logger, 512);

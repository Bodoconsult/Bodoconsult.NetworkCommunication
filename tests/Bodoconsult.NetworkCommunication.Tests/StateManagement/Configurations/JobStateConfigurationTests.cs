...
internal class JobStateConfigurationTests
{
    ...
    public void Ctor_ValidSetup_PropsSetCorrectly()
    {
        ...
        // Act  
        var config = new JobStateConfiguration(stateName, builder)
        {
    ...
    public void Clone_ValidSetup_PropsSetCorrectly()
    {
        ...
        var configOriginal = new JobStateConfiguration(stateName, builder)
        {
            CurrentContext = TestDataHelper.CreateStateMachineDevice(),
        ...
        // Act  
        var config = (JobStateConfiguration)configOriginal.Clone();

...
using IpCommunicationSample.Backend.Bll.Communication.ClientTcpIp;
using IpCommunicationSampleTests.App;

namespace IpCommunicationSampleTests.Backend.Configurators;

[TestFixture]
internal class ClientTcpIpConfiguratorTests
{
    [Test]
    public void Ctor_ValidSetup_PropsSetCorrectly()
    {
        ...
        // Act  
        var conf = new ClientTcpIpConfigurator(duplexIoFactory, monitorLoggerFactoryFactory, logDataFactory, appLoggerFactory, appEventSourceFactory, clientNotificationManager, tcpIpListenerManager);
